...
///
/// Returns the new `k_mod` value after applying `proposed_adjustment` to
/// `current_k_mod`. The result is clamped to
/// [`K_MOD_BUDGET_MIN`](crate::m1_foundation::m04_constants::K_MOD_BUDGET_MIN)..=[`K_MOD_BUDGET_MAX`](crate::m1_foundation::m04_constants::K_MOD_BUDGET_MAX).
#[must_use]
